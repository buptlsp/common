...
class ExcelHelper
{
     ...
     * @var string
     */
    private $header = "<?xml version=\"1.0\" encoding=\"%s\"?\>\n<ss:Workbook xmlns=\"urn:schemas-microsoft-com:office:spreadsheet\" xmlns:x=\"urn:schemas-microsoft-com:office:excel\" xmlns:ss=\"urn:schemas-microsoft-com:office:spreadsheet\" xmlns:html=\"http://www.w3.org/TR/REC-html40\">";
    ...
    private function _parseRow(array $row)
    {
        ...
        foreach ($row as $k => $v) {
            ...
            $v = strip_tags($v);
            $cells .= "<ss:Cell><ss:Data ss:Type=\"$type\">" . $v . "</ss:Data></ss:Cell>\n";
        }
        return "<ss:Row>\n" . $cells . "</ss:Row>\n";
    }
    ...
    public function saveXls($filename, $cols, $data)
    {
        if ($filename == '') {
            $filename = date('Y_m_d_H_i_s');
        }
